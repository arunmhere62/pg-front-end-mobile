...
interface EditPaymentModalProps {
  ...
  paymentType?: 'RENT' | 'ADVANCE'; // Add payment type to determine which statuses to show
}
...
export const EditPaymentModal: React.FC<EditPaymentModalProps> = ({
  ...
  const PAYMENT_STATUSES = paymentType === 'ADVANCE' ? ADVANCE_PAYMENT_STATUSES : RENT_PAYMENT_STATUSES;
